...
app.post("/esqueciSenha",urlencodedParser,pages.esqueciSenha2)
app.post("/redefinirSenha",urlencodedParser,pages.recuperacaoSenha)
...
app.post("/updateQuiz",urlencodedParser,pages.updateQuiz)
